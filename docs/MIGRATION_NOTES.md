...
> **Update 2026-07-08:** The Cloud Function approach described below was
> later replaced with in-app transaction logging because Cloud Functions
> require the paid Blaze plan. See `docs/SPARK_PLAN_REFACTOR.md` for the
> current mechanism. Left as-is below for historical record of the
